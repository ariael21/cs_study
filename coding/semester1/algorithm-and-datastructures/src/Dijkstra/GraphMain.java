...
class GraphMain {
	...
	public static void main(String[] args) throws FileNotFoundException {
		...
		File in = new File("cs_study/coding/semester1/algorithm-and-datastructures/src/Dijkstra/mediumG.in");
		File out = new File("cs_study/coding/semester1/algorithm-and-datastructures/src/Dijkstra/mediumG.out");
		try {
